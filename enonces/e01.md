# 🧪 Challenge E01 - Inscription utilisateur
...
- Modifier l'échantillonnage (seeding) pour créer un ou deux utilisateurs et ainsi tester le modèle.
...
- Créer un routeur dédié `auth.routes.js` et y ajouter la route `POST /auth/register`.
